# -*- coding: utf-8 -*-
"""
Created on Mon Aug  9 15:55:26 2021
...
def file_name(file_dir):
    ...
    return files
files = file_name('./rs3000_rawdata')

calib_info = pd.read_csv('./rs3000_rawdata/AAPL.csv')
calib_date = list(calib_info['Date'])
calib_date.reverse()

num_delet = 0
for f in files:
    df = pd.read_csv('./rs3000_rawdata/'+f)
    if len(df) < 71 or df['Date'][0] != '2013-12-01':
        ...
        df.to_csv('./rs3000_calibdata/'+f,index=False)