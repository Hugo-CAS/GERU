# -*- coding: utf-8 -*-
"""
Created on Mon Aug 23 16:05:58 2021
...
paras_list = ['5_5_1_0.01_0', '1_5_1_0.005_0.0005', '1_1_3_0.0005_0.05', '3_3_1_0.0005_1',
 '1_3_1_0.0005_1', '1_3_1_0.001_0.05', '5_3_1_0.0005_1', '1_1_1_0.001_0.05',
 '10_3_1_0.0005_0.05', '10_3_3_0.0005_0.05', '3_1_9_0.001_0.0005',
 '5_3_1_0.001_0.05', '10_3_1_0.001_0.05', '3_3_1_0.0005_0.05',
 '10_3_1_0.0005_1', '5_1_1_0.001_0.05', '3_3_1_0.001_0.5', '10_3_1_0.001_0.5',
 '5_3_1_0.001_0.5', '3_3_1_0.001_0.05', '5_3_3_0.005_0.05', '1_3_1_0.001_1',
 '3_3_1_0.001_1', '1_3_1_0.0005_0.5', '3_5_3_0.01_0.05', '1_3_6_0.0005_0.5',
 '3_1_1_0.0005_0.5', '3_3_1_0.0001_0.005', '5_7_1_0.01_0.0005',
 '1_1_6_0.0005_0.5', '5_3_6_0.005_0', '1_3_6_0.0001_0.05', '5_3_3_0.01_0.05',
 '5_3_1_0.001_1', '1_3_1_0.01_0.0005', '10_3_1_0.001_1', '10_3_1_0.01_0.005',
 '1_1_3_0.01_0.05', '5_3_1_0.0005_0.5', '5_1_9_0.005_0.0005',
 '3_3_1_0.0005_0.5', '10_3_1_0.01_0.5', '3_3_9_0.0005_0.5',
 '3_3_3_0.005_0.05', '10_3_1_0.0005_0.5', '5_3_9_0.0005_0.5',
 '3_3_6_0.0005_0.5', '5_7_6_0.01_0.005', '1_5_1_0.01_0.0005',
 '3_3_1_0.0001_0.05']

#setting
paras_list = paras_list[0:25]
max_break = 15
num_repeat = 10
dataset = 'rs1000'
label_matrix = 'label_matrix_up_down_3.npy'
for idx, paras in enumerate(paras_list):#
    ...
    for bs in [3]:
        for num_clusters in [3,5,10,15]:
            ...
            # train
            args.add_argument('--num_clusters', default=num_clusters, type=int)
            ...
            label_matrix = np.load('../'+dataset+'/'+dataset+'_graphdata/'+label_matrix)
            data_list = []
            ...
            for repeat in range(num_repeat):
                ...
                path = './results_v3/'+str(top_k)+'_'+str(h)+'_'+str(T)+'_'+str(l)+'_'+str(w)+'_'+str(bs)+'_'+str(num_clusters)+'_'+str(repeat)+'/'
                ...
                for i in range(54,55):
                    ...
                    loader_test = DataLoader(data_list[i-6:i+18], batch_size=24) #all in one, evaluate separately
                    ...
                    for epoch in range(num_epochs):
                        ...
                        for j, data in enumerate(loader_train):
                            optimizer.zero_grad()
                            # print(data)#x(B,N,D)
                            data.x = data.x.transpose(0,1).reshape(T, -1, args.num_nodes, 6)#.unsqueeze(dim=0) (T,bs,N,d)
                            
                            data = data.to(args.device)
                            # out, A_list_train = model(data.x)
                            out = model(data.x).view(-1, 2)
                            # print("out.shape:{}, y.shape:{}".format(out.shape, data.y.shape))
                    ...
                    ###########eval#############
                        ...
                        for k, data in enumerate(loader_test):
                            data.x = data.x.transpose(0,1).reshape(T, -1, args.num_nodes, 6)
                            data = data.to(args.device)
                        ...
                        print("month:{}, epoch:{}, TrLoss: {:.4f}, Val-ACC: {:.4f}, Val-AUC: {:.4f} Test-ACC: {:.4f}, Test-AUC: {:.4f}, time cost:{:.4f}".format(i, epoch, loss.item(), acc_val, val_auc, acc_tst, tst_auc, time.time()-start_time))
            ...
            path_2 = './results_v3/'+str(top_k)+'_'+str(h)+'_'+str(T)+'_'+str(l)+'_'+str(w)+'_'+str(bs)+'_'+str(num_clusters)+'/'
