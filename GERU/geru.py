# -*- coding: utf-8 -*-
"""
Created on Thu Aug 19 11:20:29 2021
...
from Cell import AGRNNCell

class AGRNN(nn.Module):
    def __init__(self, nhead, dim_in, dim_out, top_k, num_layers=1):
        ...
        self.dcrnn_cells.append(AGRNNCell(nhead, dim_in, dim_out, top_k))
        for _ in range(1, num_layers):
            self.dcrnn_cells.append(AGRNNCell(nhead, dim_out, dim_out, top_k))
...
class KAGRNN(nn.Module):
    def __init__(self, args):
        ...
        self.encoder = AGRNN(self.head, self.input_dim, self.hidden_dim, self.top_k, self.num_layers)
